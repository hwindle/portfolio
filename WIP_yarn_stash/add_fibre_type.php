<?php
  ...
  if (!empty($_POST['add'])) {
    $sql = 'INSERT INTO fibre (fibre) VALUES (:fibre)';
    $pdo_statement = $pdo_conn->prepare($sql);
    $result = $pdo_statement->execute(array(':fibre'=>$_POST['fibre_type']));
  }
    ...
    <body class="wrapper">
      ...
      <section id="content">
        ...
        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
          <p class="form-row">
            <label for="fibre_type">Fibres in yarn: </label>
            <input type="text" name="fibre_type" id="fibre_type" required />
          </p>
